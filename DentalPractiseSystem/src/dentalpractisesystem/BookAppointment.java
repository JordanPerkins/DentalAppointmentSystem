/*
 * Creates a JPanel to add to the GUI Frame allowing the secretary to book new appointments.
 * Calculates possible appointment times based on information received from the constructor.
 */
